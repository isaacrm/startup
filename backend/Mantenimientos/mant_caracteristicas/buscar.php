                        ...
                        <div class='container col-lg-12'>
                            <div class='row'>
                                ...
                                <form method='POST' action="buscar.php">
                                    ...
                                    <input class="col-lg-3" type="submit" name="regresar" formaction="caracteristicas.php" value="Regresar">
                                </form>
                                <div class="clearfix">
                                </div>
                                <div class="table-responsive">
                                    <table class='table table-striped table-bordered table-hover'>
                                        ...
                                        <tbody>
                                            ...
                                            $sql0 = "SELECT COUNT(*) as total_datos FROM caracteristicas WHERE titulo like '%".$buscar."'";
                                            ...
                                            $busqueda= "SELECT id_caracteristica, titulo, descripcion FROM caracteristicas WHERE titulo like '%".$buscar."' LIMIT " . (($paginacion->get_page() - 1) * $filas) . ', ' . $filas;
                                            $data="";
