                                ...
                                <div class="table-responsive">
                                    <table class='table table-striped table-bordered table-hover'>
                                        ...
                                        foreach ($PDO->query($sql) as $row) {
                                            $id_c = base64_encode($row['id_equipo']);
                                            $data .= "<tr>";
                                            ...
                                            $data .= "<td>";
                                            $data .= "<a class='btn btn-xs btn-info' href='consultar.php?id_equipo=$id_c'>Consultar</a>&nbsp;";
                                            $data .= "<a class='btn btn-xs btn-primary' href='actualizar.php?id_equipo=$id_c'>Actualizar</a>&nbsp;";
                                            $data .= "<a class='btn btn-xs btn-danger' href='eliminar.php?id_equipo=$id_c'>Eliminar</a>";
                                            $data .= "</td>";
                                            $data .= "</tr>";
                                        }
                                        print($data);
