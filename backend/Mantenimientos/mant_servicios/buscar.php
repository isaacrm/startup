                        ...
                        <div class='container col-lg-12'>
                            <div class='row'>
                                ...
                                <form method='POST' action="buscar.php">
                                    <input  class="col-lg-6" name="buscar" placeholder="Buscar por Tipo" type="text" id='buscar' autocomplete="off" maxlength="60"/>
                                    <input class="col-lg-3" type="submit" name="submit" value="Buscar">
                                    <input class="col-lg-3" type="submit" name="regresar" formaction="servicios.php" value="Regresar">
                                </form>
                                <div class="clearfix">
                                </div>
                                <div class="table-responsive">
                                    <table class='table table-striped table-bordered table-hover'>
                                        ...
                                        <tbody>
                                            ...
                                            $sql0 = "SELECT COUNT(*) as total_datos FROM servicios WHERE tipo like '%".$buscar."'";
                                            ...
                                            $busqueda= "SELECT id_servicio, tipo, descripcion, precio FROM servicios WHERE tipo like '%".$buscar."' LIMIT " . (($paginacion->get_page() - 1) * $filas) . ', ' . $filas;
                                            $data="";
