...
<nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
    ...
    <div class="sidebar-collapse menu-scroll">
        <ul id="side-menu" class="nav">
            ...
            <li><a href="../mant_servicios/servicios.php"><i class="fa fa-th-list fa-fw">
                        <div class="icon-bg bg-blue"></div>
                    </i><span class="menu-title">Servicios</span></a>

            </li>

            <li><a href="../mant_imagenes_servicios/imagenes_servicios.php"><i class="fa fa-file-o fa-fw">
                        <div class="icon-bg bg-yellow"></div>
                    </i><span class="menu-title">Imagenes por Servicios</span></a>

            </li>
            <li><a href="../mant_equipos/equipos.php"><i class="fa fa-gift fa-fw">
                        <div class="icon-bg bg-grey"></div>
                    </i><span class="menu-title">Equipo</span></a>

            </li>
            <li><a href="../mant_preguntas/preguntas.php"><i class="fa fa-sitemap fa-fw">
                        <div class="icon-bg bg-dark"></div>
                    </i><span class="menu-title">Preguntas</span></a>

            </li>
            <li><a href="../mant_politicas/politicas.php"><i class="fa fa-envelope-o">
